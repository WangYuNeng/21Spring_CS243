...
(push)(assert (and phi0 (bvsge x2 N)))(check-sat)(pop)
...
(push)(assert (and (and phi0 (and (not phi2) phi3)) (bvsge v1 N)))(check-sat)(pop)
(assert (= z1 (select data v1)))
(push)(assert (and (and phi0 (and (not phi2) (not phi3))) (bvsge (select data #x00000000) N)))(check-sat)(pop)
