...
(push)(assert (and phi0 (bvsge x2 N)))(check-sat)(get-model)(pop)
...
(push)(assert (and (and phi0 phi2) (bvsge (bvmul #x00000002 v0) N)))(check-sat)(pop)
(assert (= z0 (select data (bvmul #x00000002 v0))))
(assert (= v1 (bvsdiv (bvadd x2 (bvmul #x00000002 v0)) #x00000003)))
(push)(assert (and (and phi0 (and (not phi2) phi3)) (bvsge v1 N)))(check-sat)(get-model)(pop)
(assert (= z1 (select data v1)))
(push)(assert (and (and phi0 (and (not phi2) (not phi3))) (bvsge (select data #x00000000) N)))(check-sat)(get-model)(pop)
